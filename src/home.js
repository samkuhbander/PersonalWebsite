...
function Home() {
    return (
        <div>
            ...
            <Typography variant="h4" sx={{m:4}}>Hi, my name is Sam Kuhbander and I am a software engineering major at Miami University.  
            ...
            blockchain technology and developing an application that allows 
